...
namespace SyndAmbiance
{
    public partial class Dashboard : System.Web.UI.Page
    {
        ...
        DataSet dsUerData1 = new DataSet();
        ...
        public void AdminIfo()
        {
            ...
            admname.Text = dsUerAdminData.Tables[0].Rows[0]["UsrName"].ToString(); ;
        ...
        public void TotalROs()
        {
            ...
            MySqlConnection connection = new MySqlConnection(connstring);
            MySqlCommand cmdGetUserData = new MySqlCommand("SELECT count(robic) FROM syndro;", connection);
            connection.Open();
            MySqlDataAdapter adp = new MySqlDataAdapter();
            adp.SelectCommand = cmdGetUserData;
            adp.Fill(dsUerData1);
            lbltotalRO.Text = dsUerData1.Tables[0].Rows[0][0].ToString();
            connection.Close();
        }
