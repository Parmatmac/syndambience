<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BranchStatus.aspx.cs" MasterPageFile="~/Branchadmin.Master" Inherits="SyndAmbiance.BranchStatus" %>
...
<div class="form-element-area">
        <div class="container">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                     ...
                     <div class="cmp-tb-hd bcs-hd">
                            ...
                            <p>Please update branch ambiance status and give your valuable ratings to improve our Synd Ambiance. </p>
                            </div>
           ...
           <asp:GridView ID="brnchStatus" runat="server" 
         ...
         class="table table-bordered" EmptyDataRowStyle-ForeColor="Red" CellPadding="1" HeaderStyle-BackColor="White" HeaderStyle-ForeColor="Black" HeaderStyle-BorderColor="#CCCCCC" BackColor="White" BorderColor="#CCCCCC" RowStyle-BackColor="White" RowStyle-BorderStyle="NotSet">
                        ...
                        <Columns>
                           ...
                           <%--  <asp:TemplateField HeaderText="BIC">
                            ...
                            <asp:TemplateField HeaderText="Upload Image"  HeaderStyle-BackColor="White">
                                <ItemTemplate>
                                 
                                    <asp:FileUpload ID="areaimage" runat="server"  required="required" />
                                </ItemTemplate>
                            </asp:TemplateField>
