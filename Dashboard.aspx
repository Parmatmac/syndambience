<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="SyndAmbiance.Dashboard" %>
...
//                toolTipContent: "<b>{label}:</b> {y}",
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            axisY: {
                title: "Updated Ambience Status of Branches, Zone Wise"
            },
            data: [{
                type: "column",
                showInLegend: true,
                ...
                dataPoints: [
			{ y: 106, label: "Bangalore" },
			{ y: 125, label: "Chennai" },
			{ y: 205, label: "Hyderabad" },
			{ y: 162, label: "Delhi" },
			{ y: 133, label: "Lucknow" },
			{ y: 154, label: "Manipal" },
			{ y: 137, label: "Kolkata" },
        ...
        //SELECT COUNT(distinct(BIC)) FROM syndambiance.branchstatus  where DATE(datetime) =curdate() group by bic;
